...
부록에 구독 벤치마크(연간 할인 15~20%, trial 전환율, freemium 2~5%), take rate 벤치마크(앱스토어·배민·쿠팡), 과금 단위(value metric) 선택 기준, 행동 가격 전술 6종(타협 효과, 앵커링, 하루 얼마 프레이밍 등), AI 시대 하이브리드 과금 자료가 있습니다.
